...
void insertAtPosition(Node* &tail, Node* &head, int position, int d){
    ...
    while(cnt<position-1){ // position -1 kiya ye important hai data ko track karne ke liyea
        temp = temp->next;
        cnt++;
    }
...
Node* getStartingOfLoopNode(Node* head){
...
void removeLoop(Node* head){
    ...
    Node* startOfLoop = getStartingOfLoopNode(head);
...
int main()
{
    ...
    Node * loop = getStartingOfLoopNode(head);
